  ...
  return (
    <div className="container-terms">
      <section>
        ...
        <p>
          Welcome to Vitter App! These terms and conditions outline the rules
          and regulations for the use of Vitter's Website, located at
          https://vitterlibre.com. By accessing this website, we assume you
          accept these terms and conditions. Do not continue to use Vitter App
        ...
        <p>
          ...
          By accessing Vitter App, you agreed to use the required cookies. A
        ...
        <h2>License:</h2>
        <p>
          Unless otherwise stated, Vitter and/or its licensors own the
          intellectual property rights for all material on Vitter App. All
          intellectual property rights are reserved. You may access this from
          Vitter App for your own personal use subjected to restrictions set in
          these terms and conditions. You must not:
        </p>
        <ul>
          <li>Copy or republish material from Vitter App</li>
          <li>Sell, rent, or sub-license material from Vitter App</li>
          <li> Reproduce, duplicate or copy material from Vitter App</li>
          <li>Redistribute content from Vitter App</li>
        </ul>
        <p>This Agreement shall begin on the date hereof.</p>
        <p>
          Parts of this website offer users an opportunity to post and exchange
          opinions and information in certain areas of the website. Vitter does
          not filter, edit, publish or review Comments before their presence on
          the website. Comments do not reflect the views and opinions of Vitter,
          ...
          permitted by applicable laws, Vitter shall not be liable for the
        ...
        <p>
          Vitter reserves the right to monitor all Comments and remove any
        ...
        <p>
          You hereby grant Vitter a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Vitter; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to Vitter. Please include your name, your
        ...
        <p>
          No use of Vitter's logo or other artwork will be allowed for linking
